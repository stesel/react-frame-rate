...
function withReactFrameRate(options) {
    return function (Component) {
        var FrameRate = function (props) {
            ...
            var _a = useFrameRateManager_1.useFrameRateManager(), updateCallback = _a.updateCallback, updateFrameRate = _a.updateFrameRate, updateAnimation = _a.updateAnimation;
